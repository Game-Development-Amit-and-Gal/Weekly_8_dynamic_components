...
<img width="2393" height="1187" alt="image" src="https://github.com/user-attachments/assets/3f4b7453-b8ea-45a5-92be-af3729ac5913" />
...
## שאלה 5:
***מידע גלוי לשחקן***
השחקן מקבל מידע בסיסי ורלוונטי בזמן אמת, כגון כמות חיים, תחמושת, כסף, מספר ה־Wave הנוכחי ומספר האויבים שנותרו. מידע זה מאפשר קבלת החלטות מיידיות במהלך הקרב.

***מידע נסתר מהשחקן***
השחקן אינו יודע מראש את מיקום כל האויבים, את כמותם המדויקת בתחילת ה־Wave או את סוגי האויבים שיגיעו בהמשך. מידע זה נשמר מוסתר כדי ליצור מתח, אי־ודאות ואתגר מתמשך.

***כיצד השחקן מגלה מידע חדש***
המידע נחשף בהדרגה באמצעות התקדמות במשחק, התבוננות בסביבה, שמיעת קולות אויבים ושימוש ב־Killstreaks כגון UAV. ניסיון מצטבר מאפשר לשחקן ללמוד דפוסים ולצפות התנהגות אויבים.

***נקודת המבט והשפעתה על חוויית המשחק***
המשחק מוצג מנקודת מבט של גוף ראשון, מה שמגביר תחושת טבילה (Immersion), מגביל את שדה הראייה של השחקן ומחייב מודעות גבוהה לסביבה. נקודת מבט זו מחזקת את המתח והאינטנסיביות של חוויית ההישרדות.


## שאלה 6:
לשחקן יש שליטה ישירה על מצב העולם באמצעות פעולותיו בזמן המשחק, כגון תנועה, ירי, שימוש בציוד והפעלת Killstreaks. כל פעולה משפיעה באופן מיידי על הסביבה ועל מצב הקרב.

המשחק מתנהל בזמן־אמת, ולא לפי תורות. האויבים פועלים במקביל לשחקן, והעולם משתנה באופן רציף בהתאם להתקדמות ה־Wave ולבחירות השחקן.

בנוסף, קיימת גם שליטה עקיפה: החלטות כלכליות כמו רכישת ציוד, שדרוגים ו־Killstreaks משפיעות על האופן שבו העולם יתפתח בהמשך ה־Wave.

שילוב זה יוצר חוויית משחק דינמית, אינטנסיבית ומבוססת החלטות מהירות.

## שאלה 7:

תופעות דינאמיות מעניינות:
שחקנים גילו שבמהלך המשחק נוצרים דפוסי משחק שלא תמיד ברורים במבט ראשון, כמו ניצול נקודות חנק (chokepoints), שליטה באזורים גבוהים, ושימוש בפינות במפה כדי להשפיע על התנהגות ה-AI. בנוסף, הקושי של המשחק מורגש כעולה בצורה לא לינארית, מה שמאלץ את השחקנים לשנות אסטרטגיות תוך כדי התקדמות ה-Waves.

באגים בדינאמיקה:
קהילות דיווחו על תקלות כמו בעיות סנכרון במצב קואופ (desync) וניצול אזורים במפה שבהם האויבים מתקשים להגיע לשחקן — תופעות שאינן תואמות את כוונת המעצבים ומשפיעות על האיזון המשחקי.

לדוגמא:

:

<img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/58b799a0-c102-43a0-a9f0-113e49bc34d3" />
מקורות (בלוגים ופורומים):

Reddit – דיון על Survival Mode:
https://www.reddit.com/r/CallOfDuty/comments/1n04jzt/cod_survival_mode_in_mw3_wasnt_that_bad/

Call of Duty Wiki – פורום Survival Mode:
https://callofduty.fandom.com/wiki/Forum:MW3_Survival_mode

Steam Community – דיונים על באגים וקואופ:
https://steamcommunity.com/app/42680/discussions/


## שאלה 8:
 המשחק יצא בשנת 2011, ובשיאו כלל קהילת שחקנים עצומה של מיליוני שחקנים ברחבי העולם.
 כיום, כ־14 שנים לאחר יציאתו, הקהילה הפעילה קטנה משמעותית, אך עדיין קיימת קהילה מצומצמת של שחקנים ותיקים ונוסטלגיים המשחקים בעיקר במצבי Multiplayer ו-Survival.

***תופעות תרבותיות וחברתיות בקהילה (בזמן השיא):***

 -- תחרותיות גבוהה ומשחק קבוצתי (Clan wars, Co-op Survival)

 -- יצירת תוכן קהילתי: סרטונים, מדריכים ואסטרטגיות ביוטיוב ובפורומים

 -- תרבות של הישגים, Killstreaks ורצפים גבוהים כסמל לסטטוס

 -- שפה ייחודית וסלנג שהתפתח סביב המשחק

כיום:
המשחק נתפס כמשחק “קלאסי”, והקהילה שנותרה מאופיינת בעיקר בנוסטלגיה, שימור זיכרונות וחוויות, והשוואות למשחקי Call of Duty חדשים.
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
בסעיף זה בחרנו לשנות את כמות הצעדים שהפרש יכול לעשות.
הפרש יכול לנוע בצורה עקיפה על הלוח, באופן יותר מדויק
עבור המקום ה-(i,j) הפרש יכול לנוע אל המקומות:
1) (i±1,j±2)
...
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/e3bfc234-f062-4979-933e-cf5837f76b27" />





כעת נוסיף לפרש אפשרות לבצע תנועה ו"לאכול" את החיילים של המתמודד במקומות:
...
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/6da3a8fc-a4b1-464f-a640-48b3995798ce" />
...
הרחבת אפשרויות התנועה של הפרש מגדילה באופן משמעותי את מספר המהלכים האפשריים בכל תור, ולכן משנה את חוויית השחקן. 
אנחנו נדרשנו להתמודד עם מרחב איומים גדול יותר, מה שמגביר את תחושת חוסר הוודאות והמתח במהלך המשחק.

כתוצאה מכך, המשחק הופך לפחות צפוי ויותר טקטי, במיוחד בשלבים המוקדמים, שכן הפרש מסוגל להגיע לאזורים רחוקים בלוח בזמן קצר.
 הרגשנו שהמשחק מתגמל יצירתיות והפתעה, אך בו־זמנית מצריך ריכוז גבוה יותר ותכנון קצר־טווח.

עם זאת,עלה בדעתנו שהשינוי עלול גם לפגוע בתחושת האיזון, משום שהפרש הופך לכלי חזק במיוחד ביחס לכלים אחרים.
לכן חוויית השחקן משתנה ממשחק אסטרטגי איטי ומחושב למשחק מהיר, אגרסיבי ודינמי יותר.
